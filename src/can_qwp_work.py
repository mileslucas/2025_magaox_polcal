...
if __name__ == "__main__":
    ...
    plot_utils.save_figure(fig, paths.figures / "model_pol_eff_with_qwps")

    df = pd.DataFrame(rows)

    df.to_csv(paths.data / "pol_eff_model_with_qwps_report.csv", index=False)
    print(df)
